...
* Automated suite: **27 tests passed** on Windows / Python 3.11.3, using the project's pinned FastAPI, Pydantic and PyMuPDF dependencies. Full output: `test-results.txt`.
